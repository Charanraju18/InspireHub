...
const getInitialFormData = (user, learnerProfile) => {
  ...
  if (user.role === "Instructor" && user.instructorProfile) {
    ...
    base.previousCompanies = Array.isArray(user.instructorProfile.previousCompanies)
      ? user.instructorProfile.previousCompanies.join(", ")
      : user.instructorProfile.previousCompanies || "";
    base.instructedDomains = Array.isArray(user.instructorProfile.instructedDomains)
...
const ProfileEditForm = ({ user, learnerProfile, onClose, onUpdate }) => {
  const [formData, setFormData] = useState(getInitialFormData(user, learnerProfile));
      ...
      if (user.role === "Instructor") {
        updateData.instructorProfile = {
          ...
          previousCompanies: formData.previousCompanies
            ? formData.previousCompanies.split(",").map((s) => s.trim()).filter(Boolean)
            : [],
          instructedDomains: formData.instructedDomains
            ? formData.instructedDomains.split(",").map((s) => s.trim()).filter(Boolean)
            : [],
      ...
      if (user.role === "Learner") {
        updateData.learnerProfile = {
          ...
          interestedDomains: formData.interestedDomains
            ? formData.interestedDomains.split(",").map((s) => s.trim()).filter(Boolean)
            : [],
        ...
        <div className="container-fluid">
          <div className="row gy-3 gx-4">
            ...
            <div className="col-md-4 col-sm-6">
              ...
              <input type="text" className="form-control" name="name" value={formData.name || ""} onChange={handleChange} disabled={submitting} />
            </div>
            {/* Gender */}
            <div className="col-md-4 col-sm-6">
              <label className="form-label fw-medium">Gender</label>
              <select className="form-control" name="gender" value={formData.gender || ""} onChange={handleChange} disabled={submitting}>
            ...
            <div className="col-md-4 col-sm-6">
              ...
              <input type="text" className="form-control" name="location" value={formData.location || ""} onChange={handleChange} disabled={submitting} />
            </div>
            {/* Bio */}
            <div className="col-md-8 col-sm-12 mt-2">
              <label className="form-label fw-medium">Bio</label>
              <textarea className="form-control" name="bio" value={formData.bio || ""} onChange={handleChange} disabled={submitting} rows={2} />
            </div>
            {/* Profile Picture */}
            <div className="col-md-4 col-sm-6 mt-2">
              <label className="form-label fw-medium">Profile Picture</label>
              <input type="file" accept="image/*" className="form-control" name="profilePicture" onChange={handleFileChange} disabled={submitting} />
              {formData.profilePicture && (
                <img src={formData.profilePicture} alt="Preview" style={{ maxWidth: 80, maxHeight: 80, marginTop: 8, borderRadius: "50%" }} />
              )}
            </div>
            {/* Social Links */}
            <div className="col-12 mt-2 mb-5">
              ...
              <div className="row gy-2 gx-2">
                <div className="col-md-2 col-sm-4"><input type="text" className="form-control mb-2" name="socialLinks.linkedin" placeholder="LinkedIn" value={formData.socialLinks.linkedin || ""} onChange={handleChange} disabled={submitting} /></div>
                <div className="col-md-2 col-sm-4"><input type="text" className="form-control mb-2" name="socialLinks.github" placeholder="GitHub" value={formData.socialLinks.github || ""} onChange={handleChange} disabled={submitting} /></div>
                <div className="col-md-2 col-sm-4"><input type="text" className="form-control mb-2" name="socialLinks.twitter" placeholder="Twitter" value={formData.socialLinks.twitter || ""} onChange={handleChange} disabled={submitting} /></div>
                <div className="col-md-3 col-sm-6"><input type="text" className="form-control mb-2" name="socialLinks.portfolio" placeholder="Portfolio" value={formData.socialLinks.portfolio || ""} onChange={handleChange} disabled={submitting} /></div>
                <div className="col-md-3 col-sm-6"><input type="text" className="form-control mb-2" name="socialLinks.youtube" placeholder="YouTube" value={formData.socialLinks.youtube || ""} onChange={handleChange} disabled={submitting} /></div>
              </div>
            </div>
            {/* Instructor Fields */}
            {formData.role === "Instructor" && (
              <>
                <div className="col-12 mt-4 mb-2"><h5>Learner Profile</h5></div>
                <div className="col-md-2 col-sm-4">
                  <label className="form-label fw-medium">Years of Experience</label>
                  <input type="number" className="form-control" name="experienceYears" value={formData.experienceYears || ""} onChange={handleChange} disabled={submitting} />
                </div>
                <div className="col-md-3 col-sm-6">
                  <label className="form-label fw-medium">Currently Working At</label>
                  <input type="text" className="form-control" name="currentlyWorkingAt" value={formData.currentlyWorkingAt || ""} onChange={handleChange} disabled={submitting} />
                </div>
                <div className="col-md-3 col-sm-6">
                  <label className="form-label fw-medium">Current Role</label>
                  <input type="text" className="form-control" name="currentRole" value={formData.currentRole || ""} onChange={handleChange} disabled={submitting} />
                </div>
                <div className="col-md-4 col-sm-12">
                  <label className="form-label fw-medium">Previous Companies</label>
                  <input type="text" className="form-control" name="previousCompanies" value={formData.previousCompanies || ""} onChange={handleChange} disabled={submitting} />
                </div>
                <div className="col-md-6 col-sm-12">
                  <label className="form-label fw-medium">Instructed Domains</label>
                  <input type="text" className="form-control" name="instructedDomains" value={formData.instructedDomains || ""} onChange={handleChange} disabled={submitting} />
                </div>
                <div className="col-md-6 col-sm-12">
                  <label className="form-label fw-medium">Tech Stack</label>
                  <input type="text" className="form-control" name="techStack" value={formData.techStack || ""} onChange={handleChange} disabled={submitting} />
                </div>
              </>
            )}
            {/* Learner Fields */}
            {formData.role === "Learner" && (
              <>
                <div className="col-12 mt-4 mb-4"><h5>Learner Profile</h5></div>
                <div className="col-md-3 col-sm-6">
                  <label className="form-label fw-medium">Current Education</label>
                  <input type="text" className="form-control" name="currentEducation" value={formData.currentEducation || ""} onChange={handleChange} disabled={submitting} />
                </div>
                <div className="col-md-3 col-sm-6">
                  <label className="form-label fw-medium">Year of Study</label>
                  <input type="text" className="form-control" name="yearOfStudy" value={formData.yearOfStudy || ""} onChange={handleChange} disabled={submitting} />
                </div>
                <div className="col-md-3 col-sm-6">
                  <label className="form-label fw-medium">Preferred Learning Mode</label>
                  <select className="form-control" name="preferredLearningMode" value={formData.preferredLearningMode || ""} onChange={handleChange} disabled={submitting}>
                ...
                <div className="col-md-3 col-sm-6">
                  ...
                  <select className="form-control" name="skillLevel" value={formData.skillLevel || ""} onChange={handleChange} disabled={submitting}>
                    <option value="">Select</option>
                ...
                <div className="col-md-6 col-sm-12 mt-2">
                  ...
                  <input type="text" className="form-control" name="learningGoal" value={formData.learningGoal || ""} onChange={handleChange} disabled={submitting} />
                </div>
                <div className="col-md-6 col-sm-12 mt-2">
                  <label className="form-label fw-medium">Interested Domains </label>
                  <input type="text" className="form-control" name="interestedDomains" value={formData.interestedDomains || ""} onChange={handleChange} disabled={submitting} />
                </div>
              </>
            )}
                ...
                <div className="col-lg-8">
                  <div className="ps-lg-5">
                    ...
                    <div className="d-flex align-items-center gap-3 my-3 flex-wrap justify-content-between">
                      <h2
                        className="mb-0"
                        style={{ fontWeight: 600, fontSize: "2rem", marginRight: 16 }}
                      >
                        {user?.name || "No Name"}
                      </h2>
                      {canEdit && (
                    ...
                    <div className="d-flex align-items-center gap-24 mb-32 flex-wrap">
                      ...
                      <div className="d-flex align-items-center gap-8">
                        ...
                        <span className="text-neutral-700 text-md fw-medium">
                          {user.instructorProfile?.followers ? user.instructorProfile.followers.length : 0} Followers
                        </span>
                      </div>
                      <span className="vr bg-neutral-200 mx-2" style={{ width: 2, height: 24, display: "inline-block" }}></span>
                      <div className="d-flex align-items-center gap-8">
                        ...
                        <span className="text-neutral-700 text-md fw-medium">
                          {user.instructorProfile?.followingInstructors ? user.instructorProfile.followingInstructors.length : 0} Following
                        </span>
                      </div>
                      <span className="vr bg-neutral-200 mx-2" style={{ width: 2, height: 24, display: "inline-block" }}></span>
                      <div className="d-flex align-items-center gap-8">
                        ...
                        <span className="text-md text-warning-700 fw-semibold">
                          {user.instructorProfile?.reviews && user.instructorProfile.reviews.length > 0
                            ? (
                              user.instructorProfile.reviews.reduce((acc, r) => acc + (typeof r.rating === "number" ? r.rating : 0), 0) / user.instructorProfile.reviews.length
                            ).toFixed(1)
                            : 0}
                          <span className="text-neutral-400 fw-normal"> ({user.instructorProfile?.reviews?.length || 0})</span>
                        </span>
                      </div>
                    </div>
                    ...
                    <p className="text-neutral-500">
                      {user.bio || "Share a short bio, your teaching interests, and experience."}
                    </p>
                    <span className="d-block border border-neutral-30 my-40 border-dashed" />
                    ...
                    <div className="d-flex flex-wrap gap-8 mb-32">
                      {user.instructorProfile?.instructedDomains?.length > 0 ? (
                        user.instructorProfile.instructedDomains.map((domain, idx) => (
                          <span
                            key={idx}
              ...
              <div className="row mt-5">
                <div className="col-12">
                  ...
                  <div className="row gy-4 mb-32">
                    {user.instructorProfile?.content?.roadmapsShared?.length > 0 ? (
                      user.instructorProfile.content.roadmapsShared.map((roadmap, idx) => (
                  ...
                  <div className="row gy-4 mb-32">
                    {user.instructorProfile?.content?.liveEventsHosted?.length > 0 ? (
                      user.instructorProfile.content.liveEventsHosted.map((event, idx) => (
